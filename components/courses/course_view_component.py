...
class CourseViewComponent(BaseComponent):
    def __init__(self, page: Page):
        ...
        self.estimate_time_text = Text(page, 'course-estimated-time-info-row-view-text', 'Estimated-time')

    @allure.step('Check visible course view "{index}"')
    def check_visible(self, index: int, title: str, max_score: str, min_score: str, estimated_time: str):
        ...
        self.estimate_time_text.check_have_text(f'Estimated time: {estimated_time}', nth=index)
